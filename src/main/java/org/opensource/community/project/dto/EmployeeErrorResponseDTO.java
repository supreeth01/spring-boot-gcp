...
/**
 * The Class EmployeeErrorResponseDTO.
 */
public class EmployeeErrorResponseDTO {
    ...
    private EmployeeErrorResponseDTO nestedException;
	 ...
	 */
    public EmployeeErrorResponseDTO getNestedException() {
	 ...
	 */
    public void setNestedException(EmployeeErrorResponseDTO nestedException) {
    ...
    public String toString() {
        return "EmployeeErrorResponseDTO [errorCode=" + errorCode + ", errorMessage=" + errorMessage + ", exception=" + exception + ", nestedErrorCodes=" + nestedErrorCodes + ", nestedErrorStrings=" + nestedErrorStrings + ", nestedException=" + nestedException + "]";
    }
    /**
