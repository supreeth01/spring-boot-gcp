...
/**
 * The Class DepartmentErrorResponseDTO.
 */
public class DepartmentErrorResponseDTO {
    ...
    private DepartmentErrorResponseDTO nestedException;
	 ...
	 */
    public DepartmentErrorResponseDTO getNestedException() {
	 ...
	 */
    public void setNestedException(DepartmentErrorResponseDTO nestedException) {
    ...
    public String toString() {
        return "DepartmentErrorResponseDTO [errorCode=" + errorCode + ", errorMessage=" + errorMessage + ", exception=" + exception + ", nestedErrorCodes=" + nestedErrorCodes + ", nestedErrorStrings=" + nestedErrorStrings + ", nestedException=" + nestedException + "]";
    }
    /**
